...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        {
            var horarioAtencionDesde = _context.Medico.Where(m => m.IdMedico == idMedico).FirstOrDefault().HorarioAtencionDesde; // buscamos en _context, en la tabla medico, donde el id del medico de la tabla sea igual al que le pasamos por parametro, devuelve el first o el default y de ese objeto extrae la propiedad HorarioAtencionDesde y le asignamos todo esto a una variable
            return horarioAtencionDesde.Hour + ":" + horarioAtencionDesde.Minute;
        }

        public string TraerHorarioAtencionHasta(int idMedico)
        {
            var horarioAtencionHasta = _context.Medico.Where(m => m.IdMedico == idMedico).FirstOrDefault().HorarioAtencionHasta; // solo le asignamos a horarioDeAtencionHasta el medico que buscamos mediante el id
